...
<p align="left">
  <a href="https://my.home-assistant.io/redirect/hacs_repository/?owner=Dealwirth&repository=eventis&category=integration">
...
3. Enter Repository: `Dealwirth/eventis` (or URL: `https://github.com/Dealwirth/eventis`)
